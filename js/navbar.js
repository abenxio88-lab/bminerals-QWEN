...
const detailDropdownMenus = {
  Projects: [
    ...
    { title: 'Persian Silk Tundra Grey', detail: 'Iranian grey marble slabs', url: 'product-stones.html#persian-silk-tundra-grey', code: 'Ps', group: 'Stone' },
    { title: 'Persian Silk Block', detail: 'Iranian marble blocks', url: 'product-stones.html#persian-silk-block', code: 'Pb', group: 'Stone' },
    { title: 'Pietra Grey Block', detail: 'Iranian dark-grey blocks', url: 'product-stones.html#pietra-grey-block', code: 'Pg', group: 'Stone' },
    { title: 'Pietra Grey Slab', detail: 'Iranian polished slabs', url: 'product-stones.html#pietra-grey-slab', code: 'Ps', group: 'Stone' },
